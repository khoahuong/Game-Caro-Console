...
public class BoardCaro {
	...
	public boolean checkWinRow(String str, Point p) {
		...
		for (int row = -4; row < 5; row++) {
			if (checkLengthRow(row, p)) {
				if (str.equals(this.board[p.getX() + row][p.getY()])) {
					checked++;
					if (checked == 5) {
	...
	public boolean checkWinCol(String str, Point p) {
		...
		for (int col = -4; col < 5; col++) {
			if (checkLengthCol(col, p)) {
				if (str.equals(this.board[p.getX()][p.getY() + col])) {
					checked++;
					if (checked == 5) {
	...
	public boolean checkWinCrossDown(String str, Point p) {
		int checked = 0;
		for (int i = -4; i < 5; i++) {
			if (checkLengthCrossDown(i, p)) {
				if (str.equals(this.board[p.getX() + i][p.getY() - i])) {
					checked++;
					if (checked == 5) {
